...
namespace Bielov_IKM_721_project
{
    class MajorWork
    {
        ...
        {
            this.SaveFileName = S;// запам'ятати ім’я ф айлу для запису
        }
        ...
        public void ReadFromFile(System.Windows.Forms.DataGridView DG) // зчитування з файлу
        {
            try
            {
                ...
                System.Data.DataColumn cInput = new System.Data.DataColumn("Вхідні дані");// формуємо колонку "Вхідні да    ні"
